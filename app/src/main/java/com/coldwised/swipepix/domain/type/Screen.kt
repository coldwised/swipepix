...
enum class Screen(val route: String, val screenName: UiText, val subRoutes: List<String>? = null) {
    ...
    CartScreen("ImagesScreen", UiText.StringResource(R.string.cart_screen_name)),
    FavoritesScreen("ImagesScreen", UiText.StringResource(R.string.favorites_screen_name)),
    ProfileScreen("ImagesScreen", UiText.StringResource(R.string.profile_screen_name)),
